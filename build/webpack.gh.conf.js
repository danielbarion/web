...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  devtool: config.ghPages.productionSourceMap ? config.ghPages.devtool : false,
  output: {
  ...
  plugins: [
    ...
    new OptimizeCSSPlugin({
      cssProcessorOptions: config.ghPages.productionSourceMap
